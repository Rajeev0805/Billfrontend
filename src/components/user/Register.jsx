...
const Register = () => {
 ...
 console.log(formData);
  ...
  return (
    <div className='bg-[#1edeb8a5] size-full flex justify-center items-center'>
      <form action="" className='w-1/2 h-[90%]  rounded-3xl bg-white shadow-2xl flex  items-center flex-col gap-4 px-[80px] py-10 max-sm:w-[90%] overflow-scroll' onSubmit={handelSubmit}>
        ...
        <div className={`border-2  w-full flex justify-center items-center px-3 rounded-sm ${matched?'border-black':'bg-red-700'}`} >
        ...
        <div className='border-2  w-full flex justify-center items-center px-3 rounded-sm bg-black hover:bg-[#73ebeb] active:bg-cyan-500 active:scale-[0.985]'>
