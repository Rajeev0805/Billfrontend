...
const Login = () => {
  ...
  return (
    <div className='bg-[#efefef] size-full flex justify-center items-center'>
         <form action="" className='w-1/2 h-[70%]  rounded-3xl bg-white shadow-2xl flex  items-center flex-col gap-4 px-[80px] py-20 max-sm:w-[90%] overflow-scroll' onSubmit={handelSubmit}>
           ...
           <div className='hover:underline'>
              <Link to={"register"}>Hit me to Register</Link>
           </div>
         </form>
       </div>
  )
